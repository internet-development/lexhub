import styles from './lexhub.module.scss';
...
function LexHub() {
  const [activeTab, setActiveTab] = React.useState<TabType>('featured');
  const [searchQuery, setSearchQuery] = React.useState('');

  return (
    <>
      <Head>
        <title>LexHub - Explore ideas. Remix code. Build amazing protocols.</title>
        <meta
          name="description"
          content="Jump into the ecosystem and explore real examples. See how builders solve problems, test ideas, and turn concepts into protocols."
        />
      </Head>
